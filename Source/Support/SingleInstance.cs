...
namespace FastBuild.Dashboard.Support
{
	...
	internal static class NativeMethods
	{
		...
		public static string[] CommandLineToArgvW(string cmdLine)
		{
			...
			try
			{
				...
				argv = NativeMethods._CommandLineToArgvW(cmdLine, out numArgs);
				if (argv == IntPtr.Zero)
				{
			...
			finally
			{
				...
				IntPtr p = NativeMethods._LocalFree(argv);
...

	{
		...
		{
			commandLineArgs = SingleInstance<TApplication>.GetCommandLineArgs(uniqueName);
			...
			{
				SingleInstance<TApplication>.SignalFirstInstance(channelName, commandLineArgs);
			}
